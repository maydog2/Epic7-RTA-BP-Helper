...
const messages = {
  en: {
    ...
    toggleOn: "On",
    toggleOff: "Off",
    splitPrebanByFirstPick: "Split by first pick",
    sharedPrebans: "Shared prebans",
    allyFirstPrebans: "Ally-first",
    enemyFirstPrebans: "Enemy-first",
    warfareRules: "Warfare rules",
    warfareRulesHelp: "Warfare rules are Champion+ only. Select None for lower-rank matches.",
    warfareRuleANY: "None",
    warfareRuleSpecial: "Special",
    ...
    banPriorityTop: "Best ban",
    banPriorityHigh: "High",
    banPriorityMedium: "Medium",
    banPriorityLow: "Low",
  ...
  zh: {
    ...
    toggleOn: "开",
    toggleOff: "关",
    splitPrebanByFirstPick: "按先后手分别记住",
    sharedPrebans: "共用预禁",
    allyFirstPrebans: "我方先手",
    enemyFirstPrebans: "对方先手",
    warfareRules: "开战规则",
    warfareRulesHelp: "开战规则仅适用于优胜者及以上段位",
    warfareRuleANY: "无",
    warfareRuleSpecial: "特殊",
